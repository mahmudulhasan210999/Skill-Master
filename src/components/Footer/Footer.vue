    ...
    <div class="w-full flex items-center justify-center step_2 px-8 lg:px-20 xl:px-44 py-8 lg:py-14 xl:py-16">
      <div class="container">
        ...
        <div class="mt-3 lg:mt-0">
          <p class="text-white pb-1 lg:pb-3">Navigations</p>
          <div class="text-sm">
        ...
        <div class="mt-3 lg:mt-0">
          <p class="text-white pb-1 lg:pb-3">New Categories</p>
          <div class="text-sm">
        ...
        <div class="mt-3 lg:mt-0">
          <p class="text-white pb-1 lg:pb-3">Help & Support</p>
          <div class="text-sm">
        ...
        <div class="mt-3 lg:mt-0">
          <p class="text-white pb-1 lg:pb-3">Download Apps</p>
          <div class="py-1 lg:py-2">
            <button class="rounded border border-gray-700 h-16 w-60 flex items-center justify-start">
              <div class="p-3">
                <i class="pi pi-play" style="font-size: 30px; color: rgb(194, 30, 86)"></i>
              </div>
              <div class="">
          ...
          <div class="py-2">
            <button class="rounded border-gray-700 border h-16 w-60 flex items-center justify-start">
              <div class="p-3">
                <i class="pi pi-apple" style="font-size: 30px; color: rgb(194, 30, 86)"></i>
              </div>
              <div>
                <p class="text-white font-semibold">App Store</p>
                <p class="text-sm">Now it Available</p>
              </div>
            </button>
          </div>
        </div>
